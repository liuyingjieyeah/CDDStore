...
@interface DCShopCarViewController ()<UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout>
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView.frame = CGRectMake(0, ScreenH - collectionViewH - DCBottomTabH, ScreenW, collectionViewH);
